...
namespace OzSapkaTShirt.Controllers
{
    ...
    public class OrderProductsController : Controller
    {
        ...
        public Order UpDateBasket(long id, short quantity, bool addReMove)
        {
            Order? order;
            ...
            order = _context.Orders.Where(o => o.CustomerId == userId && o.Status == 0).Include(o => o.OrderProducts).FirstOrDefault();
            if (order == null)
            {
                order = new Order();
            ...
            order.PaymentTotal += product.Price * quantity;
