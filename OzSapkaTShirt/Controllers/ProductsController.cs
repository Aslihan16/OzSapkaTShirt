...

{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            //creatteki image ler edittede olmalı
            if (id == null || _context.Products == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,Description,Size,Model,Price,Fabric,Color,Image")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
